...
export default function Home() {
  return (
    <>
      <Navbar />
      <main>
<div className="relative w-full lg:h-[881px] flex flex-col lg:flex-row overflow-hidden">
  {/* Text Section */}
  <div className="bg-black w-full h-56 md:h-[302px] lg:h-[738px] lg:w-[496px] relative z-20">
    <div className="px-5 pt-14 gap-6 flex flex-col items-start h-full md:pl-6 md:pr-[88px] md:pt-[96px] md:gap-8 lg:pt-[131px] lg:px-[80px] lg:gap-[32px] lg:w-[630px]">
      ...
      <button className="flex px-6 py-4 text-white text-[16px] justify-center gap-2 bg-[#DA2327] self-stretch w-full font-bold md:w-[183px]">
        Request A Quote
      </button>
    </div>
  </div>
  ...
  {/* Image Section */}
  <div className="w-full h-90 md:h-[650px] bg-no-repeat bg-cover bg-center bg-[url('/assets/images/Rectangle1.png')] lg:w-[calc(100%-496px)] lg:h-full" />
</div>
        ...
        <div className='flex pt-10 px-5 w-full h-64 md:pt-16 md:px-6 md:h-[450px] lg:px-20 lg:h-[670px]'>
        ...
        <div className ='grid grid-cols-1 pt-18 gap-14 px-5 items-center md:grid-cols-2 md:gap-14 md:px-6 lg:px-20 lg:grid-cols-4 lg:gap-10'>
      ...
      <div className=" flex flex-col items-center px-5 pt-18 gap-12 md:gap-16 md:px-6 md:pt-16 lg:gap-[64px] lg:px-20 lg:items-start lg:flex-row lg:pt-[200px]">
        <div className="h-[379px] self-stretch w-full pl-2 md:h-[731px] md:pl-3 lg:pl-0">
          <div className="bg-[url('/assets/images/Group1.png')]  bg-no-repeat bg-cover bg-center aspect-square"/>
        </div>

        <div className="flex flex-col gap-6 self-stretch md:gap-10 lg:gap-10 lg:w-[584px]">
        ...
        <div className='bg-black flex pt-16 px-5 pb-6 flex-col justify-center items-center gap-6 w-full md:pt-20 md:px-6 md:pb-10 md:gap-8 lg:px-20'>
