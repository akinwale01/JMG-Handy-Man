...
export default function Navbar() {
  ...
  return () => {
    ...
    return (
        <nav className='flex py-3 px-5 justify-between items-center w-full relative z-50 lg:w-full lg:py-3 lg:px-20 lg:justify-between lg:items-center border-b border-[#E6E6E6]'>
            <div className='bg-[url(/assets/logo/bag.png)] h-20 w-20 bg-cover bg-center'
            />
            <div className='bg-[url(/assets/icons/menu-03.svg)] h-10 w-10 bg-cover bg-center lg:hidden' onClick={handleMenuClick}/>
            ...
            <div className="flex justify-end pr-5">
                <div className='bg-[url(/assets/icons/icon-menu-close.gif)] w-10 h-10 bg-center bg-no-repeat bg-cover' onClick={handleClose}/>
            </div>
