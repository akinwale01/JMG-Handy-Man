...
export default function AutoScrollCards() {
  ...
  return (
    <div ref={containerRef} className="-mt-50 px-5 w-[400px] md:w-[600px] justify-center mx-auto lg:w-full lg:px-12 md:mt-[-160px]">
      <div
        ref={scrollRef}
      ...
      >
        {[1, 2, 3].map((i) =>(
            <div
                key={i}
                className="flex-shrink-0 snap-center h-70 w-full  px-5 pt-6 flex flex-col items-start gap-10 rounded-sm bg-white shadow-[0_0_8px_0_rgba(0,0,0,0.25)] justify-center border border-gray-300  md:px-12 lg:px-10 "
            >

                <p className="text-base font-normal  md:text-xl lg:text-[14px]">
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <p className='text-base font-semibold'>Paul Hume</p>

                </div>
                <div className="bg-[url('/assets/images/Rectangle11.png')] w-36 h-[400px] bg-cover ml-auto -mt-25 lg:w-40 lg:h-20"/>
